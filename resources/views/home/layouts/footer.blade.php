                ...
                <div class="col-lg-2 col-sm-4 col-md-6 order-sm-4 order-lg-3">
                    <div class="wsus__footer_content">
                        ...
                        <ul>
                            ...
                            <li><a href="privacy-policy">Privacy and
                                    Policy</a></li>
                            <li><a href="terms-and-condition">Terms anc
                                    Conditions</a></li>
                        </ul>
                    </div>
                </div>
...
s1.async=true;
s1.src='https://embed.tawk.to/672223952480f5b4f5963cf8/1ibelm0a0';
s1.charset='UTF-8';
...
<script>
    window.addEventListener("load", function () { window.wpcc.init({ "border": "thin", "corners": "normal", "colors": { "popup": { "background": "#184dec", "text": "#fafafa !important", "border": "#0a58d6" }, "button": { "background": "#fffceb", "text": "#222758" } }, "content": { "href": "privacy-policy", "message": "This website uses essential cookies to ensure its proper operation and tracking cookies to understand how you interact with it. The latter will be set only upon approval.", "link": "More Info", "button": "Yes" } }) });
</script>


<!--bootstrap js-->
<script src="../bongdorn/frontend/js/bootstrap.bundle.min.js"></script>
<!--font-awesome js-->
<script src="../bongdorn/frontend/js/Font-Awesome.js"></script>
<!-- slick slider -->
<script src="../bongdorn/frontend/js/slick.min.js"></script>
<!-- isotop js -->
<script src="../bongdorn/frontend/js/isotope.pkgd.min.js"></script>
<!-- simplyCountdownjs -->
<script src="../bongdorn/frontend/js/simplyCountdown.js"></script>
<!-- counter up js -->
<script src="../bongdorn/frontend/js/jquery.waypoints.min.js"></script>
<script src="../bongdorn/frontend/js/jquery.countup.min.js"></script>
<!-- nice select js -->
<script src="../bongdorn/frontend/js/jquery.nice-select.min.js"></script>
<!-- venobox js -->
<script src="../bongdorn/frontend/js/venobox.min.js"></script>
<!-- sticky sidebar js -->
<script src="../bongdorn/frontend/js/sticky_sidebar.js"></script>
<!-- wow js -->
<script src="../bongdorn/frontend/js/wow.min.js"></script>
<!-- ex zoom js -->
<script src="../bongdorn/frontend/js/jquery.exzoom.js"></script>

<script src="../bongdorn/frontend/js/bootstrap-datepicker.min.js"></script>

<!--main/custom js-->
<script src="../bongdorn/frontend/js/main.js"></script>

<script src="../bongdorn/frontend/js/toastr.min.js"></script>
<script src="../bongdorn/frontend/js/select2.min.js"></script>
...
<script>
    (function ($) {
            ...
            function load_product_model(product_id) {
                ...
                $.ajax({
                    type: 'get',
                    url: "load-product-modal" + "/" + product_id,
                    success: function (response) {
